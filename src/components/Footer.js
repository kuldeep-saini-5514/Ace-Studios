...
const Footer = () => {
  ...
  return (
    <div className="flex flex-col mt-20 text-white bg-DarkBlack ">
      <div>
        <h1 className="text-center font-bold sm:text-4xl text-white mt-5 ms:text-3xl">
          FINICK
        </h1>
        ...
        <div className="mt-6 flex  sm:flex-row ms:flex-col gap-10 justify-center sm:items-start ms:items-center">
          <Link to={"/"}>
            <span
              className="text-white lg:text-xl font-semibold"
              onClick={refreshPage}
            >
              Home
            </span>
          ...
          <Link to={"service"}>
            <span className="lg:text-xl font-semibold" onClick={refreshPage}>
              Services
            </span>
          </Link>
          <Link to={"contact"}>
        ...
        <div className="sm:mt-6 ms:mt-10 flex  gap-x-16 justify-center align-middle">
          <a href="https://www.instagram.com/finick.xyz/">
            <i class="fa-brands fa-instagram text-3xl bg-DarkPurple text-white px-2.5 py-1.5 rounded-xl h-11 w-11"></i>
          </a>
        ...
        <div className="sm:mt-6 ms:mt-10 flex sm:flex-row ms:flex-col gap-10 justify-center items-center mb-16">
          ...
          <Link to={"/terms"}>
            <h1
              className="text-gray lg:text-base ms:text-sm"
              onClick={refreshPage}
            >
              Terms & Conditions
            </h1>
