...
const ThankYou = ({setResponse}) => {
  ...
  return (
    ...
    <>
    <div id='popup' className='thankyou z-50 absolute md:top-0  left-0 ms:-top-80 bg-black w-[100%]   md:h-[40rem] ms:h-[129rem] bg-opacity-50 flex justify-center items-center'>
